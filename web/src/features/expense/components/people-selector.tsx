          ...
          return (
            ...
            >
              <MemberAvatar
                ...
                className={cn("size-8 rounded-full transition-all", !isIncluded && "grayscale brightness-75")}
              />
              ...
              >
                {isIncluded && <CheckIcon className="size-3 text-primary-foreground" strokeWidth={3.5} />}
              </div>
            </div>
          );
        })}
