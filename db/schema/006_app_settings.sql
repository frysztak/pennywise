...
INSERT INTO app_settings (key, value) VALUES (
    'currencies',
    '["USD","EUR","JPY","GBP","AUD","CAD","CHF","CNY","HKD","SGD","SEK","KRW","NOK","NZD","MXN","INR","RUB","BRL","ZAR","TRY","DKK","PLN","THB","CZK","ILS","HUF","CLP","PHP","AED","ARS"]'
);

INSERT INTO app_settings (key, value) VALUES (
    'receipt_ocr_prompt',
    'Analyze this receipt and extract data as JSON.
